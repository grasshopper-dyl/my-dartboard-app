...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.error) {
      // Handle error (e.g., display a message or store the error in state)
  ...
  />
                    ...
                    <button type="submit" className="w-full h-full bg-dark-green text-white rounded-lg p-2 text-center">
                      <p>Create account</p>
                    </button>
                  </form>
